...
export type PublicNetwork = 'mainnet' | 'sepolia' | 'goerli' | 'xdai' | 'sokol' | 'fuse' | 'bsc' | 'bsctest' | 'fantom' | 'fantomtest' | 'moonbase' | 'moonriver' | 'moonbeam' | 'matic' | 'mumbai' | 'matic-zkevm' | 'matic-zkevm-testnet' | 'avalanche' | 'fuji' | 'arbitrum' | 'arbitrum-nova' | 'arbitrum-goerli' | 'arbitrum-sepolia' | 'optimism' | 'optimism-sepolia' | 'celo' | 'alfajores' | 'harmony-s0' | 'harmony-test-s0' | 'aurora' | 'auroratest' | 'hedera' | 'hederatest' | 'zksync' | 'zksync-goerli' | 'zksync-sepolia' | 'base' | 'base-goerli' | 'base-sepolia' | 'linea-goerli' | 'linea' | 'mantle' | 'scroll' | 'scroll-sepolia' | 'meld' | 'meld-kanazawa';
